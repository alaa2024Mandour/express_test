...
app.get("/users",(req,res,next)=>{
    // res.status(200).send("Hello Aloaaa") //send function can hold any type of masseges like >> test , json , html , etc
...
// >>>>> to handel the error of not found url use  --> use method  <<<<
